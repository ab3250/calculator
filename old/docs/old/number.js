 ...
 * @returns {number}
 */
 const log10 = /* #__PURE__ */ Math.log10 || function log10 (x) {
 ...
 * @returns {number}
 */
 const log1p = /* #__PURE__ */ Math.log1p || function (x) {
  return Math.log(x + 1)
}
 ...
 */
 const cbrt = /* #__PURE__ */ Math.cbrt || function cbrt (x) {
  if (x === 0) {
    return x
  }
 ...
 * @return {number} res
 */
 const expm1 = /* #__PURE__ */ Math.expm1 || function expm1 (x) {
